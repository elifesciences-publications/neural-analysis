KC.sigbins_cons.Rfunc = function(path, startt, endt) {
...
save(KC.sigbins_cons.Rfunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.sigbins_cons.Rfunc")
