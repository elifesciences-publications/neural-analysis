unineuralhist.rFunc = function(path, startt, endt, binw, psthmin, psthmax, event, cueexonly, side) { 
...
load("C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.pois.detect.uni.Rfunc")
...
#########################################################################
if(cueexonly == T) (cueexidx = KC.pois.detect.uni.Rfunc(spikelist, eventslist, startt, endt))
...
save(unineuralhist.rFunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/unineuralhist.rFunc") 
