...
presigbins = KC.sigbins_inhib_cons.Rfunc(path = paste(filepath, "sated response analysis/", sep = ""), startt, endt, event)
 
postsigbins = KC.sigbins_inhib_cons.Rfunc(path = paste(filepath, "sated response analysis/", sep = ""), startt=2720, endt=4720, event)

#removing neurons with no 'post' trials
#presigbins = presigbins[,-torem]
#postsigbins = postsigbins[,-torem]
