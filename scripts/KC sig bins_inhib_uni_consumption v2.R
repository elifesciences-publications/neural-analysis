KC.sigbins_inhib_uni_cons.Rfunc = function(path, startt, endt, side) {
...
save(KC.sigbins_inhib_uni_cons.Rfunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.sigbins_inhib_uni_cons.Rfunc")
