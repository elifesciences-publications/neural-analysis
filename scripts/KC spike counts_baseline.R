spikecounts_baseline.rFunc = function(spikes, events) { 
...
save(spikecounts_baseline.rFunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/spikecounts_baseline.rFunc") 
