KC.sigbins_inhib_uni.Rfunc = function(path, startt, endt, event, side) {
...
save(KC.sigbins_inhib_uni.Rfunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.sigbins_inhib_uni.Rfunc")
