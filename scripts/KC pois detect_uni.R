KC.pois.detect.uni.Rfunc = function(spikelist, eventslist, startt, endt) {
...
save(KC.pois.detect.uni.Rfunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.pois.detect.uni.Rfunc")
