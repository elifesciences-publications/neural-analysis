spikecounts_cons.rFunc = function(spikes, events) { 
...
save(spikecounts_cons.rFunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/spikecounts_cons.rFunc") 
