...
expresigbins = KC.sigbins_uni_cons.Rfunc(path = paste(filepath, "unilateral ctap/", sep = ""), startt, endt, side)
 
expostsigbins = KC.sigbins_uni_cons.Rfunc(path = paste(filepath, "unilateral ctap/", sep = ""), startt=2720, endt=4720, side)
...
inpresigbins = KC.sigbins_inhib_uni_cons.Rfunc(path = paste(filepath, "unilateral ctap/", sep = ""), startt, endt, side)
 
inpostsigbins = KC.sigbins_inhib_uni_cons.Rfunc(path = paste(filepath, "unilateral ctap/", sep = ""), startt=2720, endt=4720, side)
