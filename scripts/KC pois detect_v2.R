KC.pois.detect_v2.rFunc = function(spikes, events) {
...
save(KC.pois.detect_v2.rFunc, file = "C:/Users/Kevin Caref/Google Drive/RScripts/Functions/KC.pois.detect_v2.rFunc")
